...
//Get Request
axios.get("https://api.vschool.io/alexmigliori/todo")
.then(Response => {
...
//POST Request    
    axios.post("https://api.vschool.io/alexmigliori/todo", newObj)
    .then(Response => {
...
function getStuff (data){
    ...
    newDiv.remove();
        axios.delete("https://api.vschool.io/alexmigliori/todo/"+data._id)
    })
    ...
    newcheckboxDiv.addEventListener("change", (event) =>{
        if (event.target.checked) {
            ...
            axios.put("https://api.vschool.io/alexmigliori/todo/"+data._id, completedTrue)
            .catch(error => console.log(error))

            lineThrough (newTitleDiv, newDiscDiv, newPriceDiv, newImgDiv, newcheckboxDiv)
          } else {
            //set complete to false 
            axios.put("https://api.vschool.io/alexmigliori/todo/"+data._id, completedfalse)
    ...
    newSaveDivEdit.addEventListener("click", () =>{
        ...
        axios.put("https://api.vschool.io/alexmigliori/todo/"+data._id,editedObject)
    })
    })
